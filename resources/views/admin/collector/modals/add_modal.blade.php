<div class="modal fade" id="addCollectorModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.collector.store') }}" method="POST">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #FF5F00; border-color: #FF5F00;">Add Collector</button>
                </div>
            </form>
        </div>
    </div>
