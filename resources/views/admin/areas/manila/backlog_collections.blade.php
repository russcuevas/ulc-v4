                ...
                <div class="container-fluid">
                    <div class="row mb-2 align-items-center">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{ route('admin.area.clients.loans', $client->id) }}" class="btn btn-secondary btn-sm">
    ...
    <script>
        $(function() {
            ...
            $('#saveCollectionBtn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('admin.collections.payment.save') }}',
                    method: 'POST',
                    data: {
            ...
            $(document).on('click', '.reverse-collection-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('admin.collections.payment.reverse') }}',
                            method: 'POST',
                            data: {
                                _token: $('meta[name="csrf-token"]').attr('content'),
