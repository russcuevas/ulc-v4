                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="areasTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($secretaryAreas as $sArea)
                                            <tr>
        ...
        $(document).ready(function() {
            ...
            $('#sendWeeklyBtn').on('click', function() {
                ...
                Swal.fire({
                    ...
                    html: `Are you sure you want to process and collect weekly payments for the period:<br><strong>${startStr} - ${endStr}</strong>?<br><br><strong>Collect:</strong> {{ implode(', ', $secretaryAreas->pluck('areas_name')->toArray()) }}`,
                    icon: 'question',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('secretary.areas.collections.weekly_collect', ['location' => $location_name]) }}",
                            method: "POST",
                            data: {
                                date: dateVal,
                                _token: "{{ csrf_token() }}"
