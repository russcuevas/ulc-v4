                            ...
                            @if ($latestLoan)
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" name="loan_from" id="sec_edit_info_loan_from"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="loan_amount" id="sec_edit_info_loan_amount"
                                            class="form-control" value="{{ $latestLoan->loan_amount }}" required>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>Balance *</label>
                                        <input type="number" name="balance" id="sec_edit_info_balance"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="daily" id="sec_edit_info_daily" class="form-control"
...
<script>
    // Date calculation for Edit Information Modal (Secretary)
    document.getElementById('sec_edit_info_loan_from').addEventListener('change', function() {
